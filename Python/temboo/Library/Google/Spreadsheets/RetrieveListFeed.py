...
class RetrieveListFeed(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveListFeed, self).__init__(temboo_session, '/Library/Google/Spreadsheets/RetrieveListFeed')
...
class RetrieveListFeedInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('ClientSecret', value)
    def set_Password(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('Password', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('RefreshToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(RetrieveListFeedInputSet, self)._set_input('ResponseFormat', value)
    def set_SpreadsheetKey(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('SpreadsheetKey', value)
    def set_Username(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('Username', value)
    def set_WorksheetId(self, value):
        ...
        """
        super(RetrieveListFeedInputSet, self)._set_input('WorksheetId', value)
