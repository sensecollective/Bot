...
class RetrieveWorksheet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveWorksheet, self).__init__(temboo_session, '/Library/Google/Spreadsheets/RetrieveWorksheet')
...
class RetrieveWorksheetInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('ClientSecret', value)
    def set_Password(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('Password', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('RefreshToken', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('ResponseFormat', value)
    def set_SpreadsheetKey(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('SpreadsheetKey', value)
    def set_SpreadsheetName(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('SpreadsheetName', value)
    def set_Username(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('Username', value)
    def set_WorksheetId(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('WorksheetId', value)
    def set_WorksheetName(self, value):
        ...
        """
        super(RetrieveWorksheetInputSet, self)._set_input('WorksheetName', value)
