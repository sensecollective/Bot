...
class AddWorksheet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddWorksheet, self).__init__(temboo_session, '/Library/Google/Spreadsheets/AddWorksheet')
...
class AddWorksheetInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('ClientSecret', value)
    def set_ColumnCount(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('ColumnCount', value)
    def set_Password(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('Password', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('RefreshToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(AddWorksheetInputSet, self)._set_input('ResponseFormat', value)
    def set_RowCount(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('RowCount', value)
    def set_SpreadsheetKey(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('SpreadsheetKey', value)
    def set_Title(self, value):
        """
        Set the value of the Title input for this Choreo. ((required, string) The title of the new worksheet.)
        """
        super(AddWorksheetInputSet, self)._set_input('Title', value)
    def set_Username(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('Username', value)
