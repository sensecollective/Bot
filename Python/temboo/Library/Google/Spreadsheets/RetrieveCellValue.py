...
class RetrieveCellValueInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RetrieveCellValueInputSet, self)._set_input('AccessToken', value)
    ...
    def set_ClientID(self, value):
        ...
        """
        super(RetrieveCellValueInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(RetrieveCellValueInputSet, self)._set_input('ClientSecret', value)
    ...
    def set_RefreshToken(self, value):
        ...
        """
        super(RetrieveCellValueInputSet, self)._set_input('RefreshToken', value)
