...
class SearchByType(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchByType, self).__init__(temboo_session, '/Library/Google/Documents/SearchByType')
...
class SearchByTypeInputSet(InputSet):
    ...
    def set_Password(self, value):
        ...
        """
        super(SearchByTypeInputSet, self)._set_input('Password', value)
    def set_Type(self, value):
        ...
        """
        super(SearchByTypeInputSet, self)._set_input('Type', value)
    def set_Username(self, value):
        ...
        """
        super(SearchByTypeInputSet, self)._set_input('Username', value)
