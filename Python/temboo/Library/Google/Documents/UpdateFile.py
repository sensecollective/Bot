...
class UpdateFile(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateFile, self).__init__(temboo_session, '/Library/Google/Documents/UpdateFile')
...
class UpdateFileInputSet(InputSet):
    ...
    def set_FileContents(self, value):
        ...
        """
        super(UpdateFileInputSet, self)._set_input('FileContents', value)
    def set_ContentType(self, value):
        ...
        """
        super(UpdateFileInputSet, self)._set_input('ContentType', value)
    ...
    def set_Username(self, value):
        ...
        """
        super(UpdateFileInputSet, self)._set_input('Username', value)
