...
class SearchByCategory(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchByCategory, self).__init__(temboo_session, '/Library/Google/Documents/SearchByCategory')
...
class SearchByCategoryInputSet(InputSet):
    ...
    def set_MyDocs(self, value):
        ...
        """
        super(SearchByCategoryInputSet, self)._set_input('MyDocs', value)
    def set_Password(self, value):
        ...
        """
        super(SearchByCategoryInputSet, self)._set_input('Password', value)
    def set_Username(self, value):
        ...
        """
        super(SearchByCategoryInputSet, self)._set_input('Username', value)
    def set_Viewed(self, value):
        ...
        """
        super(SearchByCategoryInputSet, self)._set_input('Viewed', value)
