...
class GetUnreadMailFromSender(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetUnreadMailFromSender, self).__init__(temboo_session, '/Library/Google/Gmail/GetUnreadMailFromSender')
...
class GetUnreadMailFromSenderInputSet(InputSet):
    ...
    def set_Label(self, value):
        ...
        """
        super(GetUnreadMailFromSenderInputSet, self)._set_input('Label', value)
    def set_Password(self, value):
        ...
        """
        super(GetUnreadMailFromSenderInputSet, self)._set_input('Password', value)
    def set_ResponseMode(self, value):
        ...
        """
        super(GetUnreadMailFromSenderInputSet, self)._set_input('ResponseMode', value)
    def set_SenderEmail(self, value):
        ...
        """
        super(GetUnreadMailFromSenderInputSet, self)._set_input('SenderEmail', value)
    def set_Username(self, value):
        ...
        """
        super(GetUnreadMailFromSenderInputSet, self)._set_input('Username', value)
